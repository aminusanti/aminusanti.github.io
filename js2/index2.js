...
!(function(){
	...
	var numOfImages = window.location.search ? parseInt(window.location.search.match(/\d+$/)[0]) : 61,
		gallery = $('#gallery'),
		videos = [
			{
				title: "vid2",
				url: "http://player.vimeo.com/video/8974462?byline=0&portrait=0",
				thumb: "https://botw-pd.s3.amazonaws.com/styles/logo-thumbnail/s3/0006/5864/brand.gif?itok=Uu_QslRV"
			},
			{
				title: "Pilling Works on Owerri Ahoada Transmission Line",
				url: "https://www.youtube.com/embed/4AKf5jBq3Gg",
				thumb: "https://botw-pd.s3.amazonaws.com/styles/logo-thumbnail/s3/0006/5864/brand.gif?itok=Uu_QslRV"
			},
			{
				title: "Vid3",
			...
			{
				title: "Project 330kV Gombe-Damaturu-Maidugiri transmission lines",
				url:"images/p1.jpg",
				thumb: "images/p1s.jpg"
			}
		];
    ...
    $.ajax({
        ...
        data: {
            ...
            api_key: '3fa2ea7c01f9822d3143647fac39cd6f' // this is my own API key, please use yours
        },
	    dataType: 'jsonp',
        jsonp: 'jsoncallback'
    })
